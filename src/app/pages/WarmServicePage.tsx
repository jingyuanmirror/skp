interface WarmServicePageProps {
  onBack: () => void;
}

export function WarmServicePage({ onBack }: WarmServicePageProps) {
  return (
    <div className="flex flex-col h-full" style={{ background: "#F5F2ED" }}>
      ...
      <div className="flex-1 overflow-y-auto" style={{ scrollbarWidth: "none" }}>
        <img src="/warm-service.png" alt="暖心服务" className="w-full" style={{ display: "block" }} />
      </div>
    </div>
  );
}